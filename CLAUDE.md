...
- partners: id, user_a, user_b, created_at — mutual relationship gating cross-user shared-event visibility (migration 010; RLS: each user reads only rows they belong to)
